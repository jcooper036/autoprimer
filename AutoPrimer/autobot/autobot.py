...
def handle_command(command, channel):
    ...
    if command.startswith(EXAMPLE_COMMAND):
        ...
        # for example, if run
            ...
            # start looking for the output - if found, message the channel
...
# for file in find_files(input_loc=input_location):
